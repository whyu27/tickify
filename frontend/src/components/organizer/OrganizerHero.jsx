    ...
    <section className="relative min-h-[85vh] flex items-center justify-center bg-[#0A0A0A] overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-6 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 bg-white/5 border border-white/8 rounded-full">
          ...
          <span className="text-sm font-medium text-[#A0A0A0]">Organizer Dashboard</span>
        </div>
        ...
        <p className="text-lg md:text-xl text-[#A0A0A0] max-w-3xl mx-auto mb-10 leading-relaxed">
          Create, publish, and manage decentralized events on Tickify.
          <br />
          Track your sales and grow your audience with blockchain-powered ticketing.
        </p>
